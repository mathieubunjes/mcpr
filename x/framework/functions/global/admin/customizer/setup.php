...
//   06. Set Transients
//   07. Custom CSS Option Output
//   08. Custom JavaScript Option Output
//   09. Include Preloader
// =============================================================================
...
function x_customizer_custom_css_option_output() {
  ...
  ?>
    ...
    <style id="x-customizer-css-custom" type="text/css"><?php echo x_get_option( 'x_custom_styles' ); ?></style>
...
function x_customizer_custom_javascript_option_output() {
  ...
  <?php if ( x_get_option( 'x_custom_scripts' ) ) : ?>
    ...
    <script><?php echo x_get_option( 'x_custom_scripts' ); ?></script>
